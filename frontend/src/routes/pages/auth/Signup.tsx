    ...
    async (
      ...
      try {
        ...
        if (password.trim().length < 6)
          return {
            error: "Password must be at least 6 chracters long",
            payload: formData,
          };
        ...
        <div className="bg-slate-800 rounded-lg shadow-xl p-8">
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="flex-1 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors cursor-pointer"
                onClick={() => navigate(-1)}
              >
                Back
              </button>
              <button
                type="submit"
                className="flex-1 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors cursor-pointer disabled:bg-gray-400"
                disabled={isPending}
              >
                Create Account
              </button>
